...
syr <- tracts(state = 36, county = "Onondaga", cb = TRUE) # Get a GIS file.
...
write.csv(mytract.data, "data/mytractdata.csv")
...
??) Make a map with multiple layers. This is a work in progress and shows only the beggining steps to make a map with multiple layers.
